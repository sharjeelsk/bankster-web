									...
									<li className="nav-item">
										{props.id === "4" ?
											...
											<>
												...
												>
													<MenuItem className='border' onClick={handleClose}><Link to="/Loginrecruiter" className="nav-link">Login In</Link></MenuItem>
													<MenuItem style={{ padding: "inherit" }} onClick={handleClose}><Link to="/SignupRecruiter" className="nav-link">New Registration</Link></MenuItem>
												</Menu>
