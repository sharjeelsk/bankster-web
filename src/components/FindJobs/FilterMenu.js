...
function FilterMenu(props) {
  ...
  const renderContent = () => {
    return <div className='content'>
      ...
      <h3 style={{ marginTop: "0px" }}>Work Mode</h3>
      <FormControl>
      ...
      <h3 className='Minimum-Experience' style={{
      ...
      <p className="slider-info" style={{marginBottom: "4px"}}>Minimum Experience is {formValues.minimumExperience}</p>
