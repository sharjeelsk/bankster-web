  ...
  return (
    <div>
      <section className={props.fullWidth?"shadow searchbar-container row m-auto align-items-center width-full":"shadow searchbar-container row m-auto align-items-center"}>
        <div className={props.fullWidth?"col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3 searchbarinputbox":"col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 searchbarinputbox"}>
          <input onChange={(e)=>setSearchObj({...searchObj,title:e.target.value})} placeholder="Job Title (Manager)" />
        </div>
        ...
        <div className={props.fullWidth?"col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3 searchbarinputbox":"col-12 col-sm-12 col-md-2 col-lg-2 col-xl-2 searchbarinputbox"}>
