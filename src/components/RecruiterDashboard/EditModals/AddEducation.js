...
function AddEducation(props) {
    ...
    const onSubmit = (data)=>{
        ...
        if(props.keyD==="Edit"){
          axios.post(`${process.env.REACT_APP_DEVELOPMENT}/api/recruiter/editEducation`,{obj:{...data,startDate,endDate:current?"":endDate,current},oldObj:props.editData},{headers:{token:props.user.user}})
          .then(res=>{
            console.log(res)
          ...
          axios.post(`${process.env.REACT_APP_DEVELOPMENT}/api/recruiter/addEducation`,{obj:{...data,startDate,endDate:current?"":endDate,current}},{headers:{token:props.user.user}})
          .then(res=>{
            console.log(res)
            props.fetchRecruiterInfo(props.user.user)
            props.setOpen(false)
