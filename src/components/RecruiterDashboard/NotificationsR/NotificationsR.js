    ...
    const renderData = ()=>{
        if(singleData.schema==="job"){
            ...
            return <div>
              ...
              {/* <Button onClick={()=>props.history.push("/subscriptionr")}>Go to subscription</Button> */}
              <hr />
              <Button onClick={()=>props.history.push("/subscriptionr")} variant="outlined">Go to subscription</Button>
                <Button onClick={()=>setOpen(true)} color="error">Delete</Button>
            </div>
        }
    }
