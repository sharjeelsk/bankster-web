    ...
    <div className="candidate-card-half shadow-sm row m-auto">
        ...
        <div className="col-10 content-div">
            <div className="row m-auto">
                ...
                <p className="grey-text">{props.yearsOfExperience?props.yearsOfExperience:'Not Added'} Years of Experience | {props.currentCtc} CTC | {props.industry} | {props.functionalArea} | {props.product} | {props.noticePeriod}</p>
                </div>
